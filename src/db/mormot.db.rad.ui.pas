...
function DataSetToJson(Data: TDataSet; jsonFormat: TTextWriterJsonFormat=jsonCompact; onlyCurrentRecord:boolean=false): RawJson;
...
begin
  ...
  try
    ...
    for c := 0 to high(W.ColNames) do
       StringToUtf8(Data.Fields[c].FieldName, W.ColNames[c]);
